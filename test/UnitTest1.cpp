        ...
        */
        ...
        TEST_METHOD(no_chain_w) {
            ...
            try {
                ...
                output << "bbb" << endl;
                output.close();
                char* args[] = { "Wordlist.exe", "-w", "no_chain.txt" };
                main_serve(3, args);
            }
            catch (runtime_error const& e) {
                Assert::AreEqual(0, strcmp("There is no chain in the file!", e.what()));
        ...
        TEST_METHOD(no_chain_w_r) {
            ...
            try {
                ...
                output << "bbb" << endl;
                output.close();
                char* args[] = { "Wordlist.exe", "-w", "-r", "no_chain.txt" };
                main_serve(4, args);
            }
            catch (runtime_error const& e) {
                Assert::AreEqual(0, strcmp("There is no chain in the file!", e.what()));
        ...
        TEST_METHOD(no_chain_c_h) {
            ...
            try {
                ...
                output << "bbb" << endl;
                output.close();
                char* args[] = { "Wordlist.exe", "-c", "-h", "b","no_chain.txt" };
                main_serve(5, args);
            }
            catch (runtime_error const& e) {
                Assert::AreEqual(0, strcmp("There is no chain in the file!", e.what()));
        ...
        TEST_METHOD(no_chain_c_h_r) {
            ...
            try {
                ...
                output << "bbb" << endl;
                output.close();
                char* args[] = { "Wordlist.exe", "-c", "-r", "-h", "b","no_chain.txt" };
                main_serve(6, args);
            }
            catch (runtime_error const& e) {
                Assert::AreEqual(0, strcmp("There is no chain in the file!", e.what()));
        ...
        TEST_METHOD(has_ring_w) {
            ...
            try {
                ...
                output << "bbaa" << endl;
                output.close();
                char* args[] = { "Wordlist.exe",  "-w", "has_ring.txt" };
                main_serve(3, args);
            }
            catch (runtime_error const& e) {
                Assert::AreEqual(0, strcmp("There are rings in the file!", e.what()));
